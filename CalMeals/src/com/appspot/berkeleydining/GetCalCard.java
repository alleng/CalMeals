...
public class GetCalCard {
    ...
    public String[] getInfo(String username, String password) {
        ...
        try {
            ...
            String line = "";
            HttpGet get = new HttpGet("https://services.housing.berkeley.edu/c1c/dyn/balance.asp");
            ...
            post = new HttpPost("https://services.housing.berkeley.edu/c1c/dyn/login.asp");
