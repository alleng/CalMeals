...
public class IntroLoadDataActivity extends SherlockActivity {
	...
	public void initializeGeneralRatings() {
		...
		prefEd.putFloat("CROSSROADS_BREAKFAST",
				CurrentMenu.halls.Crossroads.Breakfast.rating).commit();
		prefEd.putFloat("CROSSROADS_LUNCH",
				CurrentMenu.halls.Crossroads.Lunch.rating).commit();
		prefEd.putFloat("CROSSROADS_DINNER",
				CurrentMenu.halls.Crossroads.Dinner.rating).commit();
		prefEd.putFloat("CAFE3_BREAKFAST",
				CurrentMenu.halls.Cafe3.Breakfast.rating).commit();
		prefEd.putFloat("CAFE3_LUNCH", CurrentMenu.halls.Cafe3.Lunch.rating)
				.commit();
		prefEd.putFloat("CAFE3_DINNER", CurrentMenu.halls.Cafe3.Dinner.rating)
				.commit();
		prefEd.putFloat("FOOTHILL_BREAKFAST",
				CurrentMenu.halls.Foothill.Breakfast.rating).commit();
		prefEd.putFloat("FOOTHILL_LUNCH",
				CurrentMenu.halls.Foothill.Lunch.rating).commit();
		prefEd.putFloat("FOOTHILL_DINNER",
				CurrentMenu.halls.Foothill.Dinner.rating).commit();
		prefEd.putFloat("CKC_BREAKFAST",
				CurrentMenu.halls.ClarkKerr.Breakfast.rating).commit();
		prefEd.putFloat("CKC_LUNCH", CurrentMenu.halls.ClarkKerr.Lunch.rating)
				.commit();
		prefEd.putFloat("CKC_DINNER", CurrentMenu.halls.ClarkKerr.Dinner.rating)
				.commit();
